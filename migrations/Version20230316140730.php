...
final class Version20230316140730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO contact (`id`, `name_id`, `display_name`, `email_address`, `password`, `super_admin`) VALUES (null, \'super\', \'super\', \'super@super.nl\', \'$2y$13$zQb6nVLleImMZgvrDXyVk.v7Wdwn9IsaA/O.Rceci2ipIAYfrS6M6\', \'1\')');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1027Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1027Platform'."
        );
